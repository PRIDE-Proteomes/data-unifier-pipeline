...
JOB_NAME="proteomes-data-unifier-release-report"
...
# LSF command to run
COMMAND="-jar ${project.build.finalName}.jar launch-data-unifier-release-report-job.xml proteomesDataUnifierReleaseReportJob"
...
# OUTPUT
STD_ERR="output/release-report-stderr.txt"
STD_OUT="output/release-report-stdout.txt"
...
##### FUNCTIONS
printUsage() {
    echo "Description: Data unifier release report pipeline."
    echo ""
    echo "Usage: ./runDataUnifierReleaseReport.sh -d|--database [-e|--email] [-j|--job-params]"

    echo "     Example: ./runDataUnifierReleaseReport.sh -e ntoro@ebi.ac.uk -d test"
